...
export const learningPathData: PathNode[] = [
    ...
    { id: 5, type: 'lesson', title: 'Địa điểm & Nơi chốn', levelTag: 'A1' ,level: 1 }, 
    ...
    // --- A2: Sơ cấp ---
    { id: 8, type: 'lesson', title: 'Kể chuyện Quá khứ', levelTag: 'A2' ,level: 1 },
    { id: 9, type: 'lesson', title: 'Kế hoạch Tương lai', levelTag: 'A2' ,level: 1 },
    ...
    { id: 14, type: 'lesson', title: 'Yêu cầu & Lời mời', levelTag: 'A2',level: 1  },
    ...
    { id: 22, type: 'lesson', title: 'Kỹ năng mềm', levelTag: 'B1' ,level: 1 },
    ...
    { id: 27, type: 'lesson', title: 'Viết báo cáo chuyên nghiệp', levelTag: 'B2' ,level: 1 },
    ...
    { id: 34, type: 'lesson', title: 'Nghệ thuật & Thiết kế', levelTag: 'C1',level: 1  },
    { id: 35, type: 'lesson', title: 'Khoa học & Nghiên cứu', levelTag: 'C1',level: 1  }, 
    { id: 36, type: 'lesson', title: 'Phân tích triết học', levelTag: 'C1' ,level: 1 },
    { id: 37, type: 'lesson', title: 'Kỹ năng đàm phán', levelTag: 'C1',level: 1  },
    
    // --- C2: Thành thạo ---
    { id: 38, type: 'lesson', title: 'Sử dụng từ Hán Việt', levelTag: 'C2' ,level: 1 },
    ...
    { id: 42, type: 'lesson', title: 'Phân tích ngữ nghĩa', levelTag: 'C2' ,level: 1 },

...
const MultipleChoiceScreen = ({ route, navigation }: any) => {
    ...
    async function playFeedbackSound(correct: boolean) {
        try {
            const { sound } = await Audio.Sound.createAsync(
                correct
                    ? require('../../../../assets/sounds/correct.mp3') // Đảm bảo đúng đường dẫn file
    ...
    const handleOptionSelect = (optionValue: string) => {
        ...
        // --- XỬ LÝ ÂM THANH & RUNG ---
        if (isAnswerCorrect) {
            playFeedbackSound(true); // Phát tiếng tíng tong
            setScore(prev => prev + 1.5);
        } else {
            playFeedbackSound(false); // Phát tiếng rẹc rẹc
...
// ... Các styles bên dưới giữ nguyên ...
const styles = StyleSheet.create({
    container: { flex: 1, backgroundColor: COLORS.white },
    loadingContainer: { flex: 1, justifyContent: 'center', alignItems: 'center' },
    headerContainer: { paddingHorizontal: 20, paddingTop: 10, backgroundColor: COLORS.white },
    progressBarBg: { height: 12, backgroundColor: '#E5E5E5', borderRadius: 8, overflow: 'hidden' },
    progressBarFill: { height: '100%', backgroundColor: COLORS.primary, borderRadius: 8 },
    progressText: { marginTop: 8, textAlign: 'center', color: COLORS.subText, fontWeight: 'bold', fontSize: 12, marginBottom: 5 },
    ...
    speechBubble: { flex: 1, backgroundColor: COLORS.white, borderWidth: 2, borderColor: '#E5E7EB', borderRadius: 16, paddingVertical: 12, paddingHorizontal: 16 },
    ...
    questionText: { fontSize: 20, fontWeight: '800', color: '#374151', lineHeight: 30, textAlign: 'left' },
    mediaPlaceholder: { marginTop: 15, height: 150, width: '100%', backgroundColor: '#bdc3c7', borderRadius: 10, justifyContent: 'center', alignItems: 'center' },
    optionsContainer: { gap: 14 },
    optionCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.white, paddingVertical: 16, paddingHorizontal: 16, borderRadius: 16, borderWidth: 2, borderColor: '#E5E7EB', borderBottomWidth: 4 },
    optionLabelContainer: { width: 34, height: 34, borderRadius: 8, backgroundColor: '#F3F4F6', justifyContent: 'center', alignItems: 'center', marginRight: 14, borderWidth: 1, borderColor: '#E5E7EB' },
    optionLabelText: { fontWeight: '700', fontSize: 14, color: '#6B7280' },
    optionText: { flex: 1, fontSize: 17, fontWeight: '600', color: '#374151' },
    rightIconContainer: { marginLeft: 10, justifyContent: 'center', alignItems: 'center' },
    radioCircle: { width: 24, height: 24, borderRadius: 12, borderWidth: 2, borderColor: '#E5E7EB', backgroundColor: 'transparent' },
    statusIcon: { width: 26, height: 26, borderRadius: 13, justifyContent: 'center', alignItems: 'center' },
    iconText: { color: 'white', fontWeight: 'bold', fontSize: 14 },
    footer: { position: 'absolute', bottom: 0, left: 0, right: 0, padding: 24, paddingBottom: 34, borderTopWidth: 0 },
    footerIcon: { width: 32, height: 32, borderRadius: 16, justifyContent: 'center', alignItems: 'center' },
    feedbackTitle: { fontSize: 19, fontWeight: '800' },
    feedbackSubtitle: { color: COLORS.error, fontSize: 15, fontWeight: '600', marginTop: 2 },
    nextButton: { paddingVertical: 16, borderRadius: 14, alignItems: 'center', width: '100%', borderBottomWidth: 4, borderBottomColor: 'rgba(0,0,0,0.1)' },
    nextButtonText: { color: COLORS.white, fontWeight: '800', fontSize: 16, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    restartButton: { backgroundColor: COLORS.primary, paddingVertical: 16, paddingHorizontal: 32, borderRadius: 30, width: '100%', alignItems: 'center' },
    restartButtonText: { color: COLORS.white, fontWeight: 'bold', fontSize: 16 },
    modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center', padding: 20 },
    modalContent: { backgroundColor: 'white', borderRadius: 20, padding: 25, alignItems: 'center', width: '100%', maxWidth: 350, elevation: 5, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 4 },

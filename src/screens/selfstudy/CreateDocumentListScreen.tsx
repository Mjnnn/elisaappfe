...
import { SelfStudyTabName } from "./selfStudyBottomTabs"; // ✅ QUAN TRỌNG: đúng type
...
type CardDraft = {
  ...
  definition: string;
  example: string;
  vocabImage?: string; // cloudinary url
...
// ====== Cloudinary config (đổi đúng của bạn) ======
const CLOUD_NAME = "dfeefsbap";
const UPLOAD_PRESET = "ktiger_unsigned";
...
const CreateDocumentListScreen: React.FC = () => {
  ...
  // ✅ FIX TYPE: dùng SelfStudyTabName
  const [activeTab, setActiveTab] = useState<SelfStudyTabName>("Create");
    ...
    <SafeAreaView style={styles.container} edges={["top", "left", "right"]}>
      ...
      <View style={styles.topBar}>
        ...
        <TouchableOpacity onPress={handleCreate} disabled={submitting} style={styles.headerAction}>
          <Text style={[styles.headerActionText, submitting && { opacity: 0.6 }]}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 140 }}>
        ...
        <View style={styles.formWrap}>
          ...
          >
            ...
            <Text style={styles.checkboxText}>Chỉ mình tôi (không công khai)</Text>
          </TouchableOpacity>
            ...
            <View key={idx} style={styles.card}>
              <View style={styles.cardHeader}>
                ...
                <TouchableOpacity
                  ...
                  style={cards.length <= 1 ? { opacity: 0.35 } : undefined}
                >
              ...
              {!!c.vocabImage && (
                <Image source={{ uri: c.vocabImage }} style={styles.previewImage} resizeMode="cover" />
              )}
            </View>
          ))}
        </View>
